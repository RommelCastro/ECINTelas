...
//Fim Inicio-------------------------------------------
  ...
  comunidadedao.salvar(comunidade, uploader3SelectedFile)
}

 $("#uploader3").on("change", function(event){ // Recebe o arquivo upado no cadastro sempre que há mudanças
  uploader3SelectedFile = event.target.files[0]
    document.getElementById('uploaderLabel3').innerHTML = uploader3SelectedFile.name //Atualiza  nome do arquivo no campo
  })
